...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url('http://papers.co/desktop/wp-content/uploads/papers.co-vg35-triangle-art-euro-blue-moda-pattern-29-wallpaper.jpg'); background-size: cover;">
		<h2 class="l-text2 t-center">
			Produtos
		</h2>
		<p class="m-text13 t-center">
			Novas coleções para 2018
		</p>
	</section>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							...
							<li class="p-t-4">
								<a href="<?=$route['index']; ?>/produtos?category=<?=$c['id_category']; ?>" class="s-text13">
									<?=$c['category_name']; ?>
								</a>
							</li>
							<?php endforeach; ?>
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<input class="s-text7 size6 p-l-23 p-r-50" type="text" name="search-product" placeholder="Buscar por produto">
						...
						<?php 
							foreach($products as $p): 
								if( $p['product_percent'] != "" ){
									...
									$value = 'de <s>R$ '.App::formatMoney($p['product_value'], 'out').'</s> por R$ '.App::formatMoney($p['product_value'], 'out');
								}else{
