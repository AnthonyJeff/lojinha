...
<html lang="pt-br">
  <head>
    ...
    <script src="https://use.fontawesome.com/a4acb955ad.js"></script>
    ...
    <title><?=$dependency['window_title']; ?></title>
  </head>
  <body>
    <?php require('views/layout/navbar.php'); ?>
    <br /><br><br>
    <div class="container">
      <fieldset><legend><?=$dependency['title']; ?></legend>
        <?php
          require($GLOBALS['path'].'/views/pages/'.$dependency['file'].'.php');
        ?>
      </fieldset>
    </div>
  </body>
